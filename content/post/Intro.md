...
- synchronize and save changed and deleted files in a separate backup catalog by [adding user parameters](/post/userparameters/) to rsync
...
(3) syncremote task, this is a kind of restore task, syncing data from a remote server to local disk on Mac
